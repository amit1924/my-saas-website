...
const TestimonialsColumn = (props: { className?: string; testimonials: typeof testimonials }) => {
  return (
    <div className={twMerge("flex flex-col gap-6 mt-10 [mask-image:linear-gradient(to bottom, transparent, black 25%, black 75%, transparent)]", props.className)}>
    ...
    <section className="bg-white py-0">
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center">
          ...
          <p className="section-description mt-5 text-center max-w-2xl">
